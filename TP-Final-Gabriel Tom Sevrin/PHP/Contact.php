...
<body class="bg-dark-bg">
    ...
    <div id="contact-success-popup" class="form-status-popup hidden">
        <div class="popup-content success">
            <i class="fas fa-check-circle text-neon-cyan text-3xl mr-3"></i>
            <div>
                <p class="font-orbitron font-bold">Transmission Réussie !</p>
                <p class="text-sm">Votre message a été envoyé et une fenêtre de messagerie s'est ouverte.</p>
            </div>
        </div>
    </div>

    <div id="contact-error-popup" class="form-status-popup hidden">
        <div class="popup-content error">
            <i class="fas fa-exclamation-triangle text-red-500 text-3xl mr-3"></i>
            <div>
                <p class="font-orbitron font-bold">Erreur de Transmission</p>
                <p class="text-sm">Désolé, une erreur est survenue lors de l'envoi. Veuillez réessayer.</p>
            </div>
        </div>
    </div>
