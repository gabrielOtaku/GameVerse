...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['register'])) {
        ...
        if (strlen($mot_de_passe) < 8) $response['errors']['mot_de_passe'] = "Le mot de passe doit contenir au moins 8 caractères.";
        ...
        if (empty($response['errors'])) {
            ...
            if ($stmt->execute()) {
                ...
                if ($conn->errno == 1062) { // 1062 est le code d'erreur pour Duplicate entry (clé unique)
...
// Si la requête est AJAX (post-soumission), on renvoie du JSON.
...
<body class="bg-dark-bg font-open-sans">
                    ...
                    <form id="registration-form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div class="input-field relative">
                                ...
                                <input type="password" id="mot_de_passe" name="mot_de_passe" class="w-full p-3 rounded-md" required minlength="8">
                                <div class="error-txt" data-error-for="mot_de_passe">Minimum 8 caractères requis.</div>
    ...
    <div id="popup-success" class="popup-overlay success-popup">
        <div class="popup-content">
            ...
            <p id="success-message" class="text-gray-300 mb-6">Votre compte a été créé avec succès ! Redirection en cours...</p>
