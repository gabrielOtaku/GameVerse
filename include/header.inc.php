...
if ($is_logged_in) {
    ...
    echo '<a class="nav-link-transition" href="profil.php">Mon Profil <i class="fas fa-user-circle"></i></a>';
    echo '<a class="nav-link-transition" href="deconnexion.php">Déconnexion <i class="fas fa-sign-out-alt"></i></a>';
    echo '</div>';
} else {
...
// STRUCTURE DE L'OVERLAY DU PANIER (Slide-in)
...
echo '<a href="panier.php" class="btn-neon-full mb-3" id="go-to-cart-btn"><i class="fas fa-eye mr-2"></i> Voir le Panier</a>';
echo '<a href="paiement.php" class="btn-neon-full pulse hidden" id="go-to-checkout-btn"><i class="fas fa-credit-card mr-2"></i> Payer la Commande</a>';
echo '</footer>';
echo '</div>';
echo '</div>';
